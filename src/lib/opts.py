...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--obj_weight', type=float, default=1,
                             help='loss weight for obj')
    # multi_pose
    ...
    self.parser.add_argument('--reg_obj', action='store_true',
                             help='regress obj conf separately')
    # exdet
